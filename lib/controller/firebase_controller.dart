...
class FirebaseService {
  ...
  Future<void> inicializarDados() async {
    ...
    if (itensSnapshot.docs.isEmpty) {
      ...
      await itensRef.add(ItensCardapio('Lanche de carne', 'Descrição do lanche de carne', 27.99, 'assets/imagens/hamburguer.png', true, 'Lanches').toJson());
      await itensRef.add(ItensCardapio('Pizza de frango', 'Descrição da pizza de frango', 45.99, 'assets/imagens/pizzaf.png', true, 'Pizzas').toJson());
      await itensRef.add(ItensCardapio('Batata frita', 'Descrição da batata frita', 19.99, 'assets/imagens/batata-frita.png', true, 'Outros').toJson());
      await itensRef.add(ItensCardapio('Lanche de outra', 'Descrição do lanche de outra', 27.99, 'assets/imagens/hamburguer.png', true, 'Lanches').toJson());
      await itensRef.add(ItensCardapio('Pizza de outra', 'Descrição da pizza de outra', 45.99, 'assets/imagens/pizzaf.png', true, 'Pizzas').toJson());
    }
  }
}
